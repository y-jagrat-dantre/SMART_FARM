...
import { Sprout, Power, Zap, Droplets, LogOut, Thermometer, Droplet, Sun, Activity } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-12">
          ...
          <SensorGauge label={t('phLevel')} value={sensorData.pH} max={14} unit="pH" icon={<Activity />} color="#f59e0b" />
          <SensorGauge label={t('lightIntensity')} value={sensorData.light} max={1000} unit="lux" icon={<Sun />} color="#eab308" />
        </div>
